...
- I'm also a `Mechanical Engineer` and `MBA`, and have corporate experience as a `Product Owner` / `Product Manager` in the financial industry.
- I enjoy `interaction` / `communication` with partners, clients, or directors as well.
- I like working in teams and making new friends with my team's partners.
- 📫 How to reach me: 
